...
class Index extends Controller
{
    ...
    public function index()
    {
        ...
        $this->addCss('/plugins/rainlab/pages/assets/css/bootstrap-columns-buttons.css', 'RainLab.Pages');
        ...
        $this->addJS('/plugins/rainlab/pages/assets/js/bootstrap-columns-buttons.js');
